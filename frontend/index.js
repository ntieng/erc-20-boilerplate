/*** SET THESE VARIABLES ***/
const contractAddress = "YOUR_CONTRACT_ADDRESS"; // Update with the address of your smart contract
const contractAbi = "YOUR_CONTACT_JSON"; // Update with an ABI file, for example "./sampleAbi.json"
...
$(document).ready(function () {
  ...
  $('#mint').click(async function () {
    ...
    let mintWeiAmount = web3.utils.toBN("0x" + (mintAmount * 10 ** tokenDecimal).toString(16));
    await mint(receiverAddress, mintWeiAmount);
  })
